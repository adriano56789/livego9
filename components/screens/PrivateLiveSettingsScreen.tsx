...
const PrivateLiveSettingsScreen: React.FC<{ onBack: () => void }> = ({ onBack }) => {
    return (
        <div className="flex flex-col h-full bg-[#111]">
            <header className="flex items-center p-4 flex-shrink-0 border-b border-white/5">
                ...
                <div className="flex-grow text-center mr-6"><h1 className="text-lg font-bold text-white">Convite Privado</h1></div>
            </header>
            <div className="p-4">
                <div className="flex items-center justify-between">
                    <span className="text-white">Aceitar convites automaticamente</span>
