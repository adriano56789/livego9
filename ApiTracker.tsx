...
import { ChevronLeftIcon, TrashIcon, PlayIcon, DatabaseIcon } from './components/icons';
...
export const getApiDefinitions = (): Array<{ group: string, endpoints: EndpointDefinition[] }> => [
    ...
    },
    {
        ...
        endpoints: [
            ...
            // FIX: Corrected api.getBlocklist call to use api.getBlocklist as defined in services/api.ts.
            { method: 'GET', path: '/users/me/blocklist', func: api.getBlocklist, params: [], collections: ['users'] },
            // FIX: Corrected api.unblockUser call to use api.unblockUser as defined in services/api.ts.
