...
exports.INITIAL_MESSAGES = exports.QUANTITY_OPTIONS = exports.GIFTS = exports.GIFT_CATEGORIES = void 0;
const react_1 = __importDefault(require("react"));
// Placeholder components for complex SVG gifts if not imported
const RocketGiftIcon = () => react_1.default.createElement('span', { className: "text-4xl" }, "🚀");
const PrivateJetGiftIcon = () => react_1.default.createElement('span', { className: "text-4xl" }, "✈️");
const RingGiftIcon = () => react_1.default.createElement('span', { className: "text-4xl" }, "💍");
const LionGiftIcon = () => react_1.default.createElement('span', { className: "text-4xl" }, "🦁");
const SportsCarGiftIcon = () => react_1.default.createElement('span', { className: "text-4xl" }, "🏎️");
const PhoenixGiftIcon = () => react_1.default.createElement('span', { className: "text-4xl" }, "🦅");
const SuperCarGiftIcon = () => react_1.default.createElement('span', { className: "text-4xl" }, "🚘");
const DragonGiftIcon = () => react_1.default.createElement('span', { className: "text-4xl" }, "🐉");
const CastleGiftIcon = () => react_1.default.createElement('span', { className: "text-4xl" }, "🏰");
const UniverseGiftIcon = () => react_1.default.createElement('span', { className: "text-4xl" }, "🌌");
const HelicopterGiftIcon = () => react_1.default.createElement('span', { className: "text-4xl" }, "🚁");
const PlanetGiftIcon = () => react_1.default.createElement('span', { className: "text-4xl" }, "🪐");
const YachtGiftIcon = () => react_1.default.createElement('span', { className: "text-4xl" }, "🛥️");
const GalaxyGiftIcon = () => react_1.default.createElement('span', { className: "text-4xl" }, "🌠");
const KingsCrownGiftIcon = () => react_1.default.createElement('span', { className: "text-4xl" }, "👑");
const PremiumDiamondGiftIcon = () => react_1.default.createElement('span', { className: "text-4xl" }, "💎");
const PrivateIslandGiftIcon = () => react_1.default.createElement('span', { className: "text-4xl" }, "🏝️");
const LuxuryCarEntryIcon = () => react_1.default.createElement('span', { className: "text-4xl" }, "🚔");
const FirePhoenixEntryIcon = () => react_1.default.createElement('span', { className: "text-4xl" }, "🔥");
const DragonEntryIcon = () => react_1.default.createElement('span', { className: "text-4xl" }, "🐲");
exports.GIFT_CATEGORIES = [
...
exports.GIFTS = [
    ...
    { id: 'gift-126', name: 'Foguete', price: 500, icon: '🚀', category: 'VIP', component: react_1.default.createElement(RocketGiftIcon), triggersAutoFollow: true },
    { id: 'gift-127', name: 'Jato Privado', price: 600, icon: '✈️', category: 'VIP', component: react_1.default.createElement(PrivateJetGiftIcon) },
    { id: 'gift-128', name: 'Anel', price: 750, icon: '💍', category: 'VIP', component: react_1.default.createElement(RingGiftIcon) },
    { id: 'gift-129', name: 'Leão', price: 800, icon: '🦁', category: 'VIP', component: react_1.default.createElement(LionGiftIcon) },
    { id: 'gift-130', name: 'Carro', price: 1000, icon: '🚗', category: 'VIP', component: react_1.default.createElement(SportsCarGiftIcon) },
    { id: 'gift-131', name: 'Fênix', price: 1200, icon: '🔥', category: 'VIP', component: react_1.default.createElement(PhoenixGiftIcon) },
    { id: 'gift-132', name: 'Supercarro', price: 1500, icon: '🏎️', category: 'VIP', component: react_1.default.createElement(SuperCarGiftIcon) },
    { id: 'gift-133', name: 'Dragão', price: 1800, icon: '🐉', category: 'VIP', component: react_1.default.createElement(DragonGiftIcon) },
    { id: 'gift-134', name: 'Castelo', price: 2000, icon: '🏰', category: 'VIP', component: react_1.default.createElement(CastleGiftIcon), triggersAutoFollow: true },
    { id: 'gift-135', name: 'Universo', price: 2500, icon: '🌌', category: 'VIP', component: react_1.default.createElement(UniverseGiftIcon) },
    { id: 'gift-136', name: 'Helicóptero', price: 3000, icon: '🚁', category: 'VIP', component: react_1.default.createElement(HelicopterGiftIcon) },
    { id: 'gift-137', name: 'Planeta', price: 4000, icon: '🪐', category: 'VIP', component: react_1.default.createElement(PlanetGiftIcon) },
    { id: 'gift-138', name: 'Iate', price: 5000, icon: '🛥️', category: 'VIP', component: react_1.default.createElement(YachtGiftIcon) },
    { id: 'gift-139', name: 'Galáxia', price: 6000, icon: '🌠', category: 'VIP', component: react_1.default.createElement(GalaxyGiftIcon) },
    { id: 'gift-140', name: 'Coroa Real', price: 8000, icon: '🤴', category: 'VIP', component: react_1.default.createElement(KingsCrownGiftIcon) },
    { id: 'gift-141', name: 'Diamante VIP', price: 10000, icon: '💎', category: 'VIP', component: react_1.default.createElement(PremiumDiamondGiftIcon) },
    { id: 'gift-142', name: 'Ilha Particular', price: 15000, icon: '🏝️', category: 'VIP', component: react_1.default.createElement(PrivateIslandGiftIcon) },
    ...
    { id: 'gift-183', name: 'Entrada de Carro de Luxo', price: 1000, icon: '🏎️', category: 'Entrada', component: react_1.default.createElement(LuxuryCarEntryIcon) },
    { id: 'gift-184', name: 'Entrada Fênix de Fogo', price: 5000, icon: '🔥', category: 'Entrada', component: react_1.default.createElement(FirePhoenixEntryIcon) },
    { id: 'gift-185', name: 'Entrada Dragão Místico', price: 10000, icon: '🐉', category: 'Entrada', component: react_1.default.createElement(DragonEntryIcon) },
...
exports.QUANTITY_OPTIONS = [1, 10, 99, 188, 520, 1314];
